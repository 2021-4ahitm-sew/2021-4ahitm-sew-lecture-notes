...
Um die Quarkus Anwendung zu debuggen einfach, _nachdem_ sie gestartet wurde, in IntelliJ 'Run -> Attach To Process' und die Anwendung auf Port 5005 auswählen.
Anschließend werden Breakpoints getroffen.
