...
|https://github.com/2021-4ahitm-sew/survey_simple_starter/blob/master/readme.adoc[Simple Survey]
|11.05.

|https://github.com/2021-4ahitm-sew/survey_router_starter/blob/master/readme.adoc[Simple Survey & Router]
|25.05.

|https://github.com/2021-4ahitm-sew/survey_server_starter/blob/master/readme.adoc[Simple Survey & Server]
|01.06.
...
* https://classroom.github.com/a/rlw0h2IC[Übung Survey]



== 2021-04-22 - Distance Learning

=== synchronous vs asynchronous

image:angular-blocking-nonblocking.png[]


=== How to program asynchronous?

image:angular-async-programming.png[]

* Links for "1. Callbacks"
** https://nodejs.org/en/docs/guides/blocking-vs-non-blocking/[Overview of Blocking vs Non-Blocking, window="_blank"]
** https://codecraft.tv/courses/angular/es6-typescript/promises/[Promises, window="_blank"]

=== System Architecture

image:angular-async-services.png[]

* siehe auch: https://www.remotestack.io/angular-httpclient-service-example-tutorial/[Angular 11 HttpClient Service Example: Http GET, POST, PUT & Update Request Tutorial, window="_blank"]
...
* https://classroom.github.com/a/mp-YwjVp[Übung Survey & Routing]
...
* Als Repo wird https://classroom.github.com/a/9GYk1-VC[17-microproject] verwendet

== 2021-05-25

* https://classroom.github.com/a/Oc2sodPZ[Übung Survey + Server]
